defmodule FluxonUIStartWeb.TodoLiveTest do
  use FluxonUIStartWeb.ConnCase

  import Phoenix.LiveViewTest
  import FluxonUIStart.TodosFixtures

  @create_attrs %{description: "some description", due: "2025-10-02"}
  @update_attrs %{description: "some updated description", due: "2025-10-03"}
